...
from erp_connector.utils.InProcessBatch import InProcessBatchManager
...
FORMATTER = OneLineExceptionHandler(
    "[%(asctime)s] : %(levelname)s [%(filename)s:%(lineno)s]:  %(message)s Context: [ %(elt_client)s : %(batch_id)s] ")
